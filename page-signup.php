...
<?php
	...
	*/
	...
	//$query5 = "UPDATE cap.Authentication SET password_hash, salt) VALUES ($1, $2, $3)";
	...
	$query3 = "INSERT INTO cap.Authentication (password_hash, salt, Email) VALUES (?,?,?)";
	$stat3 = $link->prepare($query3);
	$stat3->bind_param('sss', $pwhash, $salt, $email);
	$stat3->execute();
	$stat3->close();
	//salt and sha1 hashing
	
	header("Location: https://zcilok.cloudapp.net/capstone/index.php");
